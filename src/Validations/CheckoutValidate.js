...
export default function checkoutValidate(data) {
    ...
    if (data.ship_to_different_address != "checked") {
        ...
        if (!validator.isEmpty(data.billing_address_2) && WordMatching(data.billing_address_2)) {
    ...
    if (data.ship_to_different_address == "checked") {
        ...
        if (!validator.isEmpty(data.shipping_address_2) && WordMatching(data.shipping_address_2)) {

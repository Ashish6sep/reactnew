...
export const ECOM_URL = 'https://localhost:3003/';
export const API_URL = 'https://newdev-api.protibimbo.com/';
...
export const PUBLIC_URL = 'https://localhost:3003/';
*/
...
export const ENABLE_NEW_LOGIN = settings && settings.enable_new_signup == "yes" ? true : true;
